...
const SlideMenu = () => {
    return (
        <div className="bg-slate-100 min-h-screen w-80 fixed top-0 left-0 shadow-lg flex flex-col justify-center items-center space-y-0">

            <div className="w-full pt-60">
                <button className="flex items-center justify-center w-full px-4 py-2 text-left border-t border-b border-orange-500 mb-0">
