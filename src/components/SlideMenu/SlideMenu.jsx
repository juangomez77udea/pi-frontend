...
const SlideMenu = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`bg-perl min-h-screen w-64 fixed top-0 left-0 shadow-lg flex flex-col justify-between transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 z-30`}>
            <div className="w-full pt-20 lg:pt-24">
                <Link to={'/insumos'}>
                    <button className="flex items-center w-full px-4 py-2 text-left border-t border-b border-orange mb-1 text-blue_light hover:bg-green hover:text-perl">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="m15.5 19.925l-4.25-4.25l1.4-1.4l2.85 2.85l5.65-5.65l1.4 1.4zM21 10h-2V5h-2v3H7V5H5v14h6v2H5q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h4.175q.275-.875 1.075-1.437T12 1q1 0 1.788.563T14.85 3H19q.825 0 1.413.588T21 5zm-9-5q.425 0 .713-.288T13 4t-.288-.712T12 3t-.712.288T11 4t.288.713T12 5"></path></svg>
                ...
                <Link to={'/producto'}>
                    <button className="flex items-center w-full px-4 py-2 text-left border-t border-b border-orange mb-1 text-blue_light hover:bg-green hover:text-perl">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 32 32"><path fill="currentColor" d="M20 21h-8a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2m-8-4v2h8v-2Z" /><path fill="currentColor" d="M28 4H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2v16a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2m-2 24H6V12h20Zm2-18H4V6h24z" /></svg>
            ...
            <div className="w-full pb-4">
                <Link onClick={() => logout({ returnTo: window.location.origin })}>
                    <button className="flex items-center w-full px-4 py-2 text-left border-t border-b border-orange mt-2 text-blue_light hover:bg-green hover:text-perl">
